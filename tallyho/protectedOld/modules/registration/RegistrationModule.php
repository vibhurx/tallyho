...
class RegistrationModule extends CWebModule {
	...
	public $layout = 'application.views.layouts.main';//'application.modules.user.views.layouts.yum';
	...
	public $registrationEmail='admin@brevitylabs.co.uk';
	public $recoveryEmail='admin@brevitylabs.co.uk';
	...
	public $registrationView = 'registration'; // old value '/registration/registration/'
	public $changePasswordView = 'application.modules.user.views.user.changepassword';
	public $recoverPasswordView =  'application.modules.registration.views.registration.recovery';
