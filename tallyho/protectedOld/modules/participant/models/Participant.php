...
class Participant extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tour_id, category, player_id', 'required'),
			array('tour_id, category, player_id, seed, wild_card', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, tour_id, category, player_id, seed, wild_card', 'safe', 'on'=>'search'),
		);
	}
