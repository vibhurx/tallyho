...
class UserModule extends CWebModule {
	...
	public $layout = 'application.views.layouts.column1_p';
	//public $loginLayout = 'application.modules.user.views.layouts.login';
	public $loginLayout = 'application.views.layouts.column1_p';
  ...
  // for example, demo and Demo would be the same user then
	...
	public $adminEmail = 'admin@brevitylabs.co.uk';
	...
	public $hybridAuthProviders = array('facebook', 'twitter', 'google');
	...
	public $controllerMap=array(
		...
		'api'=>array('class'=>'YumModule.controllers.ApiController')
	);
